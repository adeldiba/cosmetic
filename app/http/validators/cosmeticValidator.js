...
class cosmeticValidator extends validator {
            ...
            check('title')
                ...
                .custom(async (value, { req }) =>{
                    if(req.query._method === 'put') {
                        ...
                        if(cosmetic.title === value) return;
                    }
                    let cosmetic = await Cosmetic.findOne({slug : this.slug(value)})
                    if(cosmetic){
...
module.exports = new cosmeticValidator();